    ...
    <section className="relative">
      <div className="container">
        <div className="flex justify-center">
          <div className="inline-flex items-center gap-2 rounded-lg bg-primary-50 px-4 py-1 text-lg font-semibold text-primary-600">
        ...
        <div className="mt-5 flex flex-col items-center text-center md:flex-row md:items-center md:justify-center md:text-left gap-5">
          ...
          <p className="max-w-4xl text-sm sm:text-lg text-neutral-2 font-semibold">
